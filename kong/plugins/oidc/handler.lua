...
function verify_bearer_jwt(oidcConfig)
    ...
    local t = "eyJhbGciOiJSUzI1NiIsInR5cCIgOiAiSldUIiwia2lkIiA6ICJKam55c1ZfSkZwVElxTDEtbDNZQ0VIOFFMYmhhS19GS1pBVjN3dTRVQ3p3In0..MBNN6YZNZiEG-sAWIDNwrDNIEBtJAKNWUHmhjN5N4Bq7Cbx9JLftCRg1JfUOkFsOjwkCgKR0C2ZWOLYGtWEKiB_IvZ-zp06MmufHwfSbXhQb21aGPJDtTxrU47e3sgd0a3hPXzy1D77jkM4SaUEkEy3DPFLnvugn5B5BnfBWPMFGkeu91OffF0fRdLD2-WdFL2VKTj-1pmayqcpADjVSREVZ-QloTwyOdXtVj7dHJeASxVofa2TgrL8Ofrg-7rmCHAlwXM6g3QC1KXd-I75GqF3DYQDSH8ot5GRkT4d97qXkL7kXFM8KjRLNxnFcqKnjki4JaYbpgbZL-5dGwNjO4A"

    local json2, err2, token2 = require("resty.openidc").bearer_jwt_verify(opts)

    kong.log.info(json2)
    kong.log.info(err2)
    kong.log.info(token2)
